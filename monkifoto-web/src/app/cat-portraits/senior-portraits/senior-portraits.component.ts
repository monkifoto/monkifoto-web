...
@Component({
  selector: 'app-senior-portraits',
  templateUrl: './senior-portraits.component.html',
  styleUrls: ['./senior-portraits.component.scss']
})
export class SeniorPortraitsComponent {
